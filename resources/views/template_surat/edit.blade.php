                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('templates.update', $template->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="title" name="title" class="w-full mt-1 p-2 border rounded-md" value="{{ $template->title }}" required>
                        </div>

                        <div class="mb-4">
                            <label for="content" class="block text-gray-700 font-medium">Konten Surat</label>
                            <textarea id="content" name="content" class="w-full mt-1 p-2 border rounded-md" rows="10" required>{{ $template->content }}</textarea>
                        </div>
